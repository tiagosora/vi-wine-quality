...
const Correlogram = ({ correlation_red_wine_dataset, correlation_white_wine_dataset }) => {
  const svgRef = useRef();
    ...
    <div className="content p-4 shadow-lg rounded-lg bg-white overflow-auto">
      ...
      <div className="correlogram-dropdown-container">
        <div className="correlogram-dropdown">
          ...
          <select value={selectedWineType} onChange={e => setSelectedWineType(e.target.value)} className="correlogram-custom-dropdown">
      ...
      <div className='flex'>
        <svg ref={svgRef} />
        <div className='flex mt-2 bg-gray-100 p-10 h-96' style={{"border-radius":"5px"}}>
            <div className='legend pr-10' style={{"text-align": "center", "border-radius":"5px"}}>
                <p>FA</p>
                <p>VA</p>
                <p>CA</p>
                <p>RS</p>
